    ...
    questions: [
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「紙を無くす、ねえ…（手を止めて）。まあ、そういう話なら、それで合わせますよ」（言いかけた何かを、しまい込む）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「全曜日に広げる…？（眉を寄せて）。火曜だからやってる話なんだけどな。まあ、そっちで決めるなら」（説明しかけて、口を閉じる）',
    ...
    questions: [
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「二人一組、ねえ…（引き継ぎ帳に手をかけたまま）。人が足りない時間帯の話なんだけどな。まあ、決まりなら従いますよ」（開きかけた帳面を、そっと戻す）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「貼り紙、ですか…（棚の方を一度見て、足は動かさない）。貼って消えるなら苦労しないんですけどね。まあ、増やしておきます」（歩きかけて、立ち止まる）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（固まっていた肩が少しほどけて）…ヒヤッとした事なら、あるにはありますよ。でも、わざわざ言うほどの事でも、ないかな」（一度言いかけて、引っ込める）',
    ...
    questions: [
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「慣れ、ねえ…（ノートに手をかけたまま）。毎日開けば早くなる話なら、とっくにそうしてますよ。まあ、そういう事にしておきますか」（広げかけたノートを、半分閉じる）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「マニュアルを作り直す…（画面に伸ばしかけた手を止めて）。場所が動くのが先なんですけどね。まあ、書いてもらえるなら、それを見ますよ」（指差そうとした画面を、閉じる）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「一つだけ、と言われると…（少し考えて）。まあ、強いて言えば、ですけど。今のままでも回ってはいるので、無理に挙げなくても」（言いかけた一つを、飲み込む）',
    ...
    questions: [
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「触らない方がいい、ねえ…（棚に向けた指を、下ろして）。本当は変えたい所も、あるんだけどな。まあ、今のままが現場のため、ってことなら」（言いかけた何かを、引っ込める）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（少し言いよどんで）…人によって違う所は、まあ、無くはないですよ。でも、両方見てもらうほど大きな差じゃ、ないですから」（挙げかけた一つを、口の中に残す）',
    ...
    questions: [
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（伝票に置いた指を、止めて）…まあ、名前が入っている以上、手続きは通ってるんですよね。日付の事は、本人に聞けば分かる話ですし。今ここで広げる事でも、ないか」（取り出しかけた原本を、ファイルに戻す）',
    ...
    questions: [
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「全部画面に、ですか…（操作しかけた手を止めて）。入庫はまだ手書きの方が早い理由があるんですけどね。まあ、慣れろ、ってことなら」（開きかけた画面を、閉じる）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「誤差、ですか…（クリックしかけた手を止めて）。一日に何百回も押すと、誤差じゃないんですけどね。まあ、このままでいい、ってことなら」（見せようとした画面を、閉じる）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（少し言いよどんで）…引っかかる所が、無いとは言わないですけど。自分のところは回ってますし、わざわざ挙げるほどの事でも、ないかな」（言いかけた一つを、飲み込む）',
    ...
    questions: [
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（取り出しかけた原本に、手を添えたまま）…本部の話を前提にしていい、と言われるなら、それで進められますね。私が見た所と、聞いただけの所の境目は…まあ、いいか」（広げかけたページを、閉じる）',
          onPoor: '「……（うなずく）。そうします」',
        },
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（少し間があって）…現物で確かめたか、と言われると…まあ、合ってるんですから、いいじゃないですか。原票まで辿るのは、ちょっと（言いかけて、口を閉じる）」',
          onPoor: '「……（それ以上は何も言わない）」',
        },
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（判子に手をかけたまま）…印影がある以上、形としては成立してる、と言われれば、そうなんですよね。誰が押したか、までは…まあ、そこまで疑うと、きりがないですし」（手にした判子を、引き出しに戻す）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「根拠の資料、ですか…（ファイルに伸ばした手を、止めて）。承認は下りてるんですから、それでいいじゃないですか。何を見て押したか、までは…今さら掘り返す話でも」（探しかけた手を、引っ込める）',
          onPoor: '「……（それ以上は言わない）」',
        },
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「見栄えする指標に寄せる、ですか…（少し迷って）。レビューを思えば、それが一番手堅いんでしょうね。現場の方は…まあ、後からでも、ついてくるでしょうし」（言いかけた本音を、飲み込む）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「困った場面、と言われると…（少し考えて）。まあ、無いとは言いませんけど。今すぐどうこう、というほどでも。あれば嬉しい、くらいの話ですよ」（出かかった一つを、引っ込める）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「外せない一つ、ですか…（少し考えて）。そう絞られると、かえって迷いますね。一つ挙げかけて…いや、やっぱりお任せした方が、早いかもしれない」（言いかけた一つを、引っ込める）',
    ...
    questions: [
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「触らぬ神、ですか…（言いかけて）。確かに、理由も分からず触って怒らせるよりは、無難ですね。本当の理由を確かめる、というのは…まあ、藪蛇かもしれませんし」（思い当たりかけた何かを、しまい込む）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「無くなると困る例外、ですか…（少し考えて）。一つ、思い当たらなくもないんですが。まあ、揃えた方が楽なのは確かですし、わざわざ挙げるほどの事でも」（言いかけた一つを、引っ込める）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「（詰まっていた言葉が、少しほどけて）…救われた場面が、無かったとは言いませんけど。昔の話ですし、今さら持ち出すほどの事でも、ないかな」（言いかけた何かを、また飲み込む）',
          onPoor: '「……（沈黙が続く）」',
        },
      },
    ],
    ...
    questions: [
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「一律の金額で区切る、ですか…（履歴に伸ばした手を、止めて）。それなら迷いはなくなりますね。工程によって響き方が違うんですが…まあ、線が一本ある方が、分かりやすいか」（引き出しかけた履歴を、戻す）',
          onPoor: '「……（うなずく）。そうします」',
        },
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「怖い判断、ですか…（少し言いよどんで）。一つ、無くはないんですが。まあ、あの人なら大丈夫でしょうし、わざわざ口に出すほどの事でも、ないかな」（挙げかけた一つを、引っ込める）',
    ...
    questions: [
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「一通り揃える、ですか…（メモに伸ばした手を、止めて）。それは助かりますけど。本当に効く一点が、どこか、と言われると…まあ、全部あれば、その中に入ってるでしょうし」（手繰りかけたメモを、閉じる）',
      ...
      },
      {
        ...
        finalReactions: {
          ...
          onMid:
            '「一手だけ、ですか…（少し考えかけて）。そう言われると、一つ思い浮かびはするんですが。まあ、どれが効くか分からないなら、全部やっておいた方が、取りこぼしは無いかな」（考えかけた一手を、引っ込める）',
