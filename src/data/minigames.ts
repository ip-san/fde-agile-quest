...
const DRILL_SETS: RawDrillSet[] = [
  ...
  // 13. チーム内の合意形成を掘る（team：役割をまたいで本音と詰まりを聞き取る）
  {
    theme: 'team',
    questions: [
      {
        text: 'さっき会議で「それは無理そう」と言いかけて、止めましたよね。どこで詰まりそうだったんですか？',
        good: true,
        response:
          '「…正直、出荷側の人に一回も話を通せてないんです。こっちで決めた段取りが向こうの手順とぶつかる気がして。でも、その場では言い出せなくて」',
        followUps: [
          { text: '出荷側とぶつかりそうなのは、具体的にどの作業の引き渡しの所ですか？', good: true },
          {
            text: '言い出せなかったのは、場の空気のせいですか、それとも誰に聞けばいいか分からなかったからですか？',
            good: true,
          },
          {
            // 巧い悪手：返答の「話を通せてない」を引いて寄り添うふりで、関係者に当たらず段取りだけ全員に通達して合意した体に逃げる
            text: '「話を通せてない」のが原因なら簡単です。決めた段取りを全員あての通達として一斉に流してしまえば、それで話は通ったことになりますよね',
            good: false,
          },
          {
            text: '段取りで迷うのは時間の無駄ですから、ここは一番経験のある人のやり方に全員合わせる、と決めてしまえば早いですよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し声が大きくなって）…そう、検品から出荷に渡す所です。あそこ、誰が責任持つか曖昧で。それ、ずっと言いたかったんです（ようやく本題に入れた顔）」',
          onMid:
            '「全員に通達、ですか…（少し考えて）。まあ、流せば一応みんな目は通しますけど。——通したのと、納得して動くのは、別ですよね？ そこは、どう担保するんです？」（核心の「誰が責任を持つか」は伏せたまま、逆に問いを返してはぐらかす）',
          onPoor: '「……（口をつぐむ）。じゃあ、そのやり方で合わせます」',
        },
      },
      {
        text: 'この一週間で、いちばん時間を溶かした作業は何でしたか？',
        good: true,
        response:
          '「他チームへの確認待ちですね。一つ聞くたびに半日返事が来なくて、その間こっちは手が止まる。気づいたら待ち時間ばっかりで」',
        followUps: [
          { text: 'その確認待ち、どの種類の確認がいちばん返ってこないんですか？', good: true },
          { text: '待っている間、本当に手が止まりますか？ 先に進められる作業は無かったですか？', good: true },
          {
            text: '確認待ちが原因なら、もう確認の工程ごと省いてしまえばいいですよね。各自が判断で進めれば、待ち時間はまるごと消えます',
            good: false,
          },
          {
            text: '待たされて手が止まるのは相手の都合ですから、こちらはどうにもなりません。返事が遅い相手を上に報告して、急かしてもらいましょう',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（待ち件数のメモを開いて）…在庫の引当確認、これが一番多い。週に十何回も聞いてる。ここをまとめて朝に片付けられたら、だいぶ違う（自分で改善の糸口を掴んだ様子）」',
          onMid:
            '「先に進められる作業、ですか…（メモに目を落として）。あるにはあるんですけど。ただ、確認が来てから手戻りするのも嫌で、結局待っちゃうというか…まあ、性分ですかね」（沈黙の代わりに、進めない言い訳を重ねて核心をぼかす）',
          onPoor: '「…（メモを閉じる）。まあ、待つしかないですよね」',
        },
      },
      {
        text: '要するに、気合いが足りなくて遅れてるだけですよね？',
        good: false,
        response: '「…はあ、まあ、頑張ります」（そう言ったきり、目線が下がって会話が止まる）',
        followUps: [
          { text: '責めたいわけじゃないんです。実際に手が止まる瞬間を、一つだけ教えてくれますか？', good: true },
          { text: '言い方がきつかったかも。今チームで一番、誰に負荷が寄ってると感じます？', good: true },
          {
            text: '前向きなお返事ありがとうございます。各自がもう一段気合いを入れる、ということで、この話は一区切りにしましょう',
            good: false,
          },
          {
            text: '気持ちは伝わりました。みんながこの調子で踏ん張ってくれれば遅れは取り戻せるはずなので、来週また進捗を見ましょう',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し間があって）…手が止まるのは、レビュー待ちの時です。一人にしか頼めなくて、その人が捕まらないと、全部そこで詰まる（ようやく本当の詰まりを口にした）」',
          onMid:
            '「負荷が寄ってる人、ですか…（少し肩の力が抜けて）。まあ、一人いるにはいますけど。本人も忙しいのは分かってますし、ここで名前を出して角が立つのも嫌ですし、言ったところで人が増えるわけでもないですしね」（沈黙でなく、言えない理由を並べて核心をぼかす）',
          onPoor: '「…（うつむく）。頑張ります」',
        },
      },
      {
        text: 'みんな、いつも通りで問題ないですよね？',
        good: false,
        response: '「ええ、まあ、特には」（誰も口火を切らず、互いの顔を見合わせるだけで終わる）',
        followUps: [
          {
            text: '聞き方を変えます。この一週間で「これ、自分だけ困ってるのかな」と思った事、ありませんでしたか？',
            good: true,
          },
          {
            text: '順番に一人ずつ——今いちばん「誰かに手伝ってほしい」作業を、一つだけ挙げてもらえますか？',
            good: true,
          },
          {
            text: '問題が無いなら何よりです。では今のやり方は全員が支持しているということで、このまま変えずに進めましょう',
            good: false,
          },
          {
            text: '特に異論が出ないということは合意が取れている証拠ですから、議論はこれで終わりにして、各自の作業に戻りましょう',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（一人がおずおずと手を挙げて）…実は、戻し入れの手順、自分だけ我流でやってて。合ってるか、ずっと不安だったんです（堰を切ったように、他からも声が出始める）」',
          onMid:
            '「手伝ってほしい作業、ですか…（一人が言いかけて、周りを見回して）。——いや、まあ、棚の電球が切れてるのは前から気になってて。それくらいなら言っておきます」（肝心の作業の詰まりは伏せ、当たり障りのない一点だけ出してかわす）',
          onPoor: '「…（また顔を見合わせて、誰も話さない）。大丈夫です」',
        },
      },
    ],
  },
  // 14. 役割横断の段取りを掘る（team：誰が何待ちかを解いて合意を作る）
  {
    theme: 'team',
    questions: [
      {
        text: 'いま止まっている仕事は、何待ちになっていますか？',
        good: true,
        response:
          '「私のは、仕様が固まるのを待ってる状態で。でも仕様を決める人は『現場の意見が出揃ってから』と言うし、現場は『仕様が見えないと意見も言えない』と言うし…全員、お互い待ちなんです」',
        followUps: [
          { text: 'その三者、一度同じ場に集めて、待ちの輪を解いたことはありますか？', good: true },
          { text: '「お互い待ち」のうち、どこか一つだけ先に動かせる所があるとしたら、どこですか？', good: true },
          {
            // 巧い悪手：返答の「全員お互い待ち」を引いて整理したふりで、当人を集めず自分が間に立って伝書鳩する＝合意を握らない逃げ
            text: '「全員お互い待ち」なら、私が間に入って各自の言い分を順番に伝え回せば、わざわざ全員を集めなくても回りますよね',
            good: false,
          },
          {
            text: '誰も動けないなら、まず仕様を私の方で決め切ってしまいましょう。決まったものを下ろせば、現場も意見の出しようがありますよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し前のめりになって）…そうか、一度も三者で集まってないですね。現場の人に“仕様のたたき台”を見せながら聞けば、待ちの輪が切れるかもしれない（自分から動こうとする顔）」',
          onMid:
            '「一つだけ先に動かす、ですか…（少し考えて）。動かせそうな所はあるんですけど。——それ、勝手に動いて後で仕様とずれたら、手戻りの責任は誰が取るんです？ そこがはっきりするなら、動きますよ」（解ける糸口は伏せ、責任の所在を問い返してかわす）',
          onPoor: '「…（肩をすくめる）。まあ、待つしかないですね」',
        },
      },
      {
        text: '誰か一人に、負荷が寄っていませんか？',
        good: true,
        response:
          '「…ありますね。急ぎの判断は、結局あの人に集まる。本人は『自分でやった方が早い』と言うんですけど、その人が休んだ日は、全部止まります」',
        followUps: [
          { text: 'その人に集まる「急ぎの判断」、中身を分けると、他の人でも捌けるものはどれですか？', good: true },
          { text: '「自分でやった方が早い」の裏に、任せると不安な理由がありそうです。それは何ですか？', good: true },
          {
            text: 'その人が一番できるなら、無理に分散させない方が安全です。今まで通りその人に集約して、まわりは補助に徹してもらいましょう',
            good: false,
          },
          {
            text: '一人に寄ってるのが問題なら、判断を全員に均等に割り振ってしまえばいいですよね。誰がやっても同じ、で機械的に回しましょう',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し考えてから）…急ぎの判断のうち、半分は前例があるんです。それなら手順に落とせば、他の人でも捌ける。本人も、本当はそっちを手放したいはずで（具体策にたどり着いた様子）」',
          onMid:
            '「任せると不安な理由、ですか…（言いよどんで）。一応あるんですけど。本人の判断にケチをつけるみたいで言いづらいですし、まだ失敗したわけでもないですし、藪をつついても、ね」（沈黙でなく、言えない理由を並べて核心を避ける）',
          onPoor: '「…（首を振る）。あの人がいる限りは、回ってますから」',
        },
      },
      {
        text: '誰のせいで遅れたのか、はっきりさせませんか？',
        good: false,
        response: '「…さあ、それは」（場の空気が固まり、誰も視線を合わせなくなる）',
        followUps: [
          { text: '犯人探しがしたいわけじゃないんです。同じ詰まりが、どの工程で繰り返し起きてますか？', good: true },
          { text: '言い方が良くなかった。仕組みとして、どこを直せば次は詰まらずに済みそうですか？', good: true },
          {
            text: '原因の所在をうやむやにすると同じ事が起きますから、やはり今回の遅れの責任が誰にあるかは、この場で明確にしておきましょう',
            good: false,
          },
          {
            text: '誰の問題か曖昧だと改善しようがありませんから、まず一番手の遅かった人を特定して、本人に再発防止を約束させましょう',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（強張っていた空気が少しほどけて）…繰り返してるのは、引き渡しの所ですね。誰のせいというより、渡す時の決まりが無いから、毎回そこで止まる（仕組みの話に戻ってきた）」',
          onMid:
            '「どこを直せば、ですか…（少し考えかけて）。直す所はある気はするんですけど。下手に仕組みを変えて、今うまく回ってる所まで崩れたら困りますし、現場にも新しい手順を覚えてもらわないといけないし…まあ、当面はこのままでも回りますよ」（前向きに考えかけて、変えない理由を並べて引き返す）',
          onPoor: '「…（黙ったまま）。まあ、たまたまですよ」',
        },
      },
      {
        text: 'もっと頑張れば終わる、ということでいいですか？',
        good: false,
        response: '「…はい、まあ、そうですね」（同意とも諦めともつかない返事で、それきり黙る）',
        followUps: [
          { text: '頑張りの量の話じゃなく——同じ作業で、毎回ここで手が止まるって所、ありませんか？', good: true },
          { text: '今のやり方のまま量だけ増やしたら、最初にきしむのはどの工程だと思いますか？', good: true },
          {
            text: 'やる気があるなら何よりです。では各自もう一段ペースを上げる、ということで、不足分はみんなの踏ん張りで埋めましょう',
            good: false,
          },
          {
            text: '終わると本人が言うなら大丈夫でしょう。では予定は変えず、このまま走り切ってもらう方向で進めましょう',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し間があって）…毎回止まるの、検品の確認待ちです。あそこだけ、いくら頑張っても自分じゃ早くできない。仕組みの問題なんです（頑張りでは解けない一点を口にした）」',
          onMid:
            '「最初にきしむ工程、ですか…（少し考えて）。心当たりはあるんですけど。ただ、そこを今いじると他に影響が出そうですし、繁忙期も近いし、変えるなら落ち着いてからの方が…まあ、当面は頑張りでもたせます」（核心の手前で、後回しの理由を並べて濁す）',
          onPoor: '「…（うなずく）。頑張ります」',
        },
      },
    ],
  },
  // 15. 任せる線を見極める（inin：移譲の範囲と関所をどこに置くか）
  {
    theme: 'inin',
    questions: [
      {
        text: 'まず小さく任せて確かめるなら、どこから始めるのが安全ですか？',
        good: true,
        response:
          '「…そうですね、戻し入れの記録あたりなら。間違えても在庫の数字だけだし、後から直せる。逆に出荷の確定は、出てしまったら戻せないので、そこは渡せないです」',
        followUps: [
          { text: '「後から直せる」範囲と「戻せない」範囲、その境目はどの工程で切り替わりますか？', good: true },
          { text: '戻し入れの記録から任せるとして、人が最後に一度だけ確かめる関所はどこに残しますか？', good: true },
          {
            // 巧い悪手：返答の「後から直せる」を引いて肯定しつつ、戻せない出荷確定まで一気に渡す＝関所を残さず任せきる
            text: '「後から直せる」のなら、もう戻し入れに限らず出荷の確定まで全部任せてしまいましょう。直せるんだから、止める関所なんて要らないですよね',
            good: false,
          },
          {
            text: '小さく区切るのは手間ですから、いっそ全工程まとめて渡して、走りながら危ない所を本人に覚えてもらった方が早いですよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（手順表を指でたどって）…ここ、出荷確定の一歩手前。ここに人の確認を一個だけ残せば、あとは任せられる。線が見えました（任せ方の見取り図ができた顔）」',
          onMid:
            '「関所をどこに、ですか…（少し考えて）。残した方がいい気はするんですけど。——ただ、確認を一個挟むと、その分また誰かの手が要りますよね。それ、結局任せたことになります？ 楽にならないなら、意味あります？」（関所の置き所は詰めず、逆に問いを返してはぐらかす）',
          onPoor: '「…（手順表を閉じる）。まあ、おいおい考えます」',
        },
      },
      {
        text: '間違えたとき、元に戻せる経路は用意できていますか？',
        good: true,
        response:
          '「…正直、そこは詰めてないです。動かすことばかり考えてて。失敗したら、その時に手で直せばいいかな、と。でも大口だと、手作業で戻すのは現実的じゃないかもしれない」',
        followUps: [
          { text: '手で戻せなくなるのは、どのくらいの規模からですか？ その線を先に引いておきませんか', good: true },
          {
            text: '「動かすこと」と「戻せること」、今は片方しか用意できてない。戻し手順だけ先に作れますか？',
            good: true,
          },
          {
            text: '戻せる経路を考えるのは、何か壊れてからで十分です。まだ起きてもいない失敗に備えるより、まず動かして成果を出す方が先ですよね',
            good: false,
          },
          {
            text: '手で直せるなら経路は要りません。失敗のたびに人が対処する運用にしておけば、わざわざ戻し手順を作り込む必要はないですよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し背筋が伸びて）…そうか、戻し手順が先か。一定の規模を超えたら自動で止める、それなら手作業に頼らず戻せる。動かす前に、そこを作ります（順番を組み替えた顔）」',
          onMid:
            '「戻し手順を先に、ですか…（少し考えかけて）。作っておいた方がいいのは分かるんですけど。完璧な戻し方を詰めてると、いつまでも動き出せないですし、まずは小さく動かして、問題が出てから足す方が現実的というか…まあ、起きてから考えても、そう手遅れにはならないでしょう」（前向きに考えかけて、後回しの理由を並べて引き返す）',
          onPoor: '「…（うなずく）。動かしてから考えます」',
        },
      },
      {
        text: '速くて優秀なんだから、もう全部任せてしまっていいですよね？',
        good: false,
        response: '「…まあ、速いのは確かなんですけど」（手放しでは頷けない様子で、語尾が濁る）',
        followUps: [
          {
            text: '「速いのは確か」だけど何か引っかかってますね。一つだけ、任せるのが怖い判断があるとしたら何ですか？',
            good: true,
          },
          { text: '速さに任せる前に——出力が間違っていた時、誰がどこで気づける形になってますか？', good: true },
          {
            text: '優秀で速いなら任せ切らないのはもったいないです。いちいち人が確認するのをやめて、結果だけ受け取る形にしてしまいましょう',
            good: false,
          },
          {
            text: '速いものに人が口を挟むとかえって遅くなりますから、確認は省いて、問題が起きた時だけ後から人が出ていく運用で十分ですよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し考えてから）…怖いのは、取引先に出る書類ですね。速いぶん、間違っててもそのまま出ちゃう。あそこだけは、人が一回見ないと（不安の正体を言い当てた様子）」',
          onMid:
            '「気づける形、ですか…（少し言いよどんで）。今は、ちゃんとは作れてないんですけど。今のところ大きな間違いも出てないですし、止める仕組みを挟むと速さが死ぬのももったいないですし…まあ、優秀なんだから、そう変なものは出さないでしょう」（沈黙でなく、確かめない言い訳を重ねて核心を避ける）',
          onPoor: '「…（頷く）。では、任せ切ります」',
        },
      },
      {
        text: 'AIがやってくれるなら、もう人は見なくていいですよね？',
        good: false,
        response: '「…そう言われると、そうかもしれないですけど」（割り切れない様子で、言葉が続かない）',
        followUps: [
          {
            text: '全部任せる前に一つだけ——AIの出力が静かに間違ってた時、それは今どこで止まりますか？',
            good: true,
          },
          { text: '人が見ない、の前に。影響が一番大きい判断はどれで、そこだけ関所を残せませんか？', good: true },
          {
            text: 'AIに任せると決めたなら中途半端が一番危ないですから、人の確認は全部外して、完全に任せ切ってしまった方がいっそ安全ですよね',
            good: false,
          },
          {
            text: '機械がやることに人がいちいち介入するのは時代遅れですから、もう全工程AIに委ねて、人は結果だけ見ればいいですよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し表情が変わって）…静かに間違ってたら、今は誰も気づかないですね。それは怖い。影響の大きい所だけ、人が見る関所を残します（任せる線が見えた様子）」',
          onMid:
            '「関所を残す、ですか…（少し考えかけて）。残した方がいいんでしょうけど。——その関所、結局誰が張るんです？ 人が見るなら、AIに任せた意味、半分無くなりません？ そこが回るなら、置きますよ」（残し所は詰めず、逆に問いを返してかわす）',
          onPoor: '「…（うなずく）。じゃあ、全部任せます」',
        },
      },
    ],
  },
  // 16. 移譲の段取りを確かめる（inin：任せる順番と確かめ方を一緒に設計する）
  {
    theme: 'inin',
    questions: [
      {
        text: '失敗したら、影響が及ぶ範囲はどこまでですか？',
        good: true,
        response:
          '「在庫の数字がずれるだけなら、棚卸で直せます。でも一度出荷の伝票が動くと、取引先の請求まで連鎖する。そこから先は、こっちだけじゃ戻せないんです」',
        followUps: [
          { text: 'その「連鎖が始まる一点」、伝票が動く手前ですよね。そこに止める関所を置けませんか？', good: true },
          { text: '棚卸で直せる範囲なら、まずそこから任せる——という順番で組めそうですか？', good: true },
          {
            text: '連鎖するのが怖いなら、いっそ最初から全部こちらで握っておきましょう。一切任せなければ、連鎖の心配もありませんよね',
            good: false,
          },
          {
            text: '影響範囲が読めてるなら、もう細かい線引きは要りません。全工程まとめて任せて、連鎖が起きたら都度こちらが尻拭いすればいいですよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（工程図に線を引きながら）…ここだ。伝票が動く一歩手前。ここに関所を置けば、その先の連鎖は止められる。手前は任せて、ここだけ人が見る（任せ方の設計図ができた顔）」',
          onMid:
            '「棚卸で直せる範囲から、ですか…（図に伸ばした手を止めて）。順番に任せるのは分かるんですけど。——途中まで任せて、残りを私が持つと、結局どこまでが誰の責任か、かえって曖昧になりません？ そこがはっきりするなら、その順番で組みますよ」（連鎖の一点は伏せ、責任の境目を問い返してかわす）',
          onPoor: '「…（図を閉じる）。まあ、当面は私が全部見ます」',
        },
      },
      {
        text: '人が最後に確かめる関所は、どこに残しますか？',
        good: true,
        response:
          '「うーん、全部に確認を挟むと、結局自分でやるのと変わらなくなるんですよね。かといって、どこも見ないのは怖い。その“ちょうどいい一点”が、自分でも分かってなくて」',
        followUps: [
          { text: '「ここを外したら一番痛い」という判断が一つあるはずです。それはどこですか？', good: true },
          { text: '全部見るのと、どこも見ないの間で——間違いが取り返しのつく範囲は、人を外せませんか？', good: true },
          {
            text: '迷うくらいなら、いっそ全工程に確認を挟みましょう。手間は増えますが、全部人が見れば見落としはゼロになって一番安全ですよね',
            good: false,
          },
          {
            text: 'どこに置くか決まらないなら、関所はいったん無しで動かしましょう。問題が出た所に後から足していけば、自然と必要な場所に関所ができますよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し考えてから）…外したら一番痛いのは、取引先に出る前の最終確認です。そこ一点だけ人が見て、あとは任せる。それなら、自分でやるのと変わる（迷いが晴れた顔）」',
          onMid:
            '「取り返しのつく範囲は人を外す、ですか…（少し考えかけて）。理屈は分かるんですけど。どこまでが“取り返しがつく”か、人によって感覚が違いますし、線を引いた後で「なんで外した」と言われるのも嫌ですし…まあ、当面は全部見ておく方が、丸い気もして」（前向きに考えかけて、引かない理由を並べて止まる）',
          onPoor: '「…（黙る）。全部見ておきます」',
        },
      },
      {
        text: '失敗したら、その時に考えればいいんじゃないですか？',
        good: false,
        response: '「…まあ、それはそうなんですけど」（どこか落ち着かない様子で、語尾が消える）',
        followUps: [
          {
            text: '行き当たりばったりにしない為に——「その時」が手遅れになる失敗だけ、先に洗い出しませんか？',
            good: true,
          },
          { text: '後で考えるにしても、気づける形は要ります。間違いに最初に気づくのは、今は誰ですか？', good: true },
          {
            text: '起きてもいない失敗に時間を使うのが一番もったいないですから、備えはやめて、まず任せて走り出してしまいましょう',
            good: false,
          },
          {
            text: '考えるのは後でいいので、まず全部任せて成果を出しましょう。戻し方や確認の話は、何か起きてから整えれば十分ですよね',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し背筋が伸びて）…手遅れになるのは、取引先に出た後ですね。それだけは「その時」じゃ遅い。出る前に止める一点だけ、先に決めておきます（先回りの一手にたどり着いた）」',
          onMid:
            '「手遅れになる失敗を先に、ですか…（少し考えかけて）。洗い出した方がいいんでしょうけど。全部想定してたらキリが無いですし、考えすぎて動けないのも本末転倒ですし、まずは動かして、出たら直す方が早い気も…まあ、起きてから考えても、間に合わなくはないでしょう」（前向きに考えかけて、後回しの理由を並べて引き返す）',
          onPoor: '「…（うなずく）。動かしてから考えます」',
        },
      },
      {
        text: 'うまくいってるなら、もう任せっぱなしでいいですよね？',
        good: false,
        response: '「…今のところは、回ってますね」（うまくいっている割に、どこか言い切れない響きがある）',
        followUps: [
          {
            text: '「今のところ」に少し含みがありますね。回っているのを、今は誰がどこで確かめてますか？',
            good: true,
          },
          { text: '任せっぱなしで静かに壊れ始めた時、最初にそれが表に出るのはどの数字ですか？', good: true },
          {
            text: 'うまく回ってるものをわざわざ点検するのは手間の無駄ですから、問題が起きるまでは誰も見ない、で放っておいて大丈夫ですよね',
            good: false,
          },
          {
            text: '順調なら任せた判断は正しかったわけですから、もう確認の仕組みは外して、完全に任せ切ってしまいましょう',
            good: false,
          },
        ],
        finalReactions: {
          onGreat:
            '「（少し考えてから）…確かめてるの、実は誰もいないですね。回ってる“ように見えてる”だけかもしれない。週に一度でいいから、数字を一つ見る所だけ残します（任せっぱなしの穴に気づいた様子）」',
          onMid:
            '「最初に表に出る数字、ですか…（少し考えて）。どれかには出るんでしょうけど。今は問題が起きてるわけでもないですし、見る人を立てるとまたその人の手が要りますし、回ってるうちは触らない方がいいような…まあ、何かあれば、その時は気づくでしょう」（沈黙でなく、見ない言い訳を重ねて核心をぼかす）',
          onPoor: '「…（うなずく）。じゃあ、このまま任せます」',
        },
      },
    ],
  },
