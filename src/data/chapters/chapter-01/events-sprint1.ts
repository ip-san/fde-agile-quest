...
export const SPRINT1_EVENTS: GameEvent[] = [
...

  {
    ...
    advocacy: {
      ...
      sm: '「見える化したい」——その“何を”が抜けている。倉庫で、誰が何に困っているのか確かめてこい。',
      dev: '「見える化」、ダッシュボードを作る前に…倉庫で実際の使われ方を見てきてほしいです。',
    },
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「ただの画面追加でしょ？」って言われると…正直ちょっと不安で。倉庫で実態を見てきてほしいです。',
    },
    narrative:
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「もう2つ足せませんか」、正直キツいかも…開発室で見積りを一緒に直しましょう。',
    },
    narrative:
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「どうせ紙に…」って言われる画面、僕らが何か外してるんです。倉庫で見てきてほしいです。',
    },
    narrative:
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「見て覚えるもん」、それ自動化の一番の壁なんです…倉庫で実物を見てきてほしいです。',
    },
    narrative:
