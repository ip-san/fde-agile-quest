...
export const SPRINT1_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    title: '毎月ズレる棚',
    narrative:
      '月次の{{棚卸}}で、帳簿と実在庫がまたズレた。経理の間宮さんは「数字だけ合わせといて」と急かす。横で田淵さんがつぶやく。「毎月、この棚だけなんだよな」。',
    hearingOptions: [
  ...
  },
  {
    ...
    narrative:
      '{{フィジカルAI}}による自動化の鍵は、田淵さんや山田さんの“勘”だ。だがコツを尋ねると、返ってくるのはいつも同じ言葉。「これは見て覚えるもんだ」「言葉になんか、できんよ」。彼らは気づいている。自動化は、自分の仕事を奪う。だから、手の内を見せない。',
    hearingOptions: [
