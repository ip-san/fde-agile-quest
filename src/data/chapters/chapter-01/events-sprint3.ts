...
export const SPRINT3_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    title: '最後のレトロ：根を張る文化',
    narrative:
      'キャンペーン最後の{{レトロスペクティブ}}。信頼を積み、現場と一緒に隠れたノウハウを形にした自動化は、本番でも例外まで含めて回っている。{{フォーキャスト}}した分を例外処理まで{{完成の定義}}に織り込んで届けきり、持ち越しを最小に締めた。田淵さんが言う。「正直、最初はあんたが仕事を奪いに来たと思ってた」。学びをどう残す？',
    hearingOptions: [
