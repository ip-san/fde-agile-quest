...
export const SPRINT3_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「動く」のと「使われる」のは別物で…正直そこが一番こわいです。会議室で、現場の使い方を確かめてきてほしいです。',
    },
    narrative:
  ...
  },
  {
    ...
    title: '「いっそ3PLに出せば？」',
    advocacy: {
      po: '「いっそ3PLに出せば？」——逃げる前に、自分たちで掴める価値があるはずだ。倉庫で確かめてきてくれ。',
      sm: '「いっそ3PLに出せば？」と言う前に。倉庫で、本当に手放していいのか見てこい。',
      dev: '「いっそ3PLに出せば？」って案、僕らが楽になるだけかもで…倉庫で現場の事情を見てきてほしいです。',
    },
    narrative:
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「あなたが抜けたら…」って言われるの、嬉しいけど危ういです。会議室で、引き継ぎの形を確かめてきてほしいです。',
    },
    narrative:
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「誰のミスだ」って空気になると、誰も本当のこと言わなくなって…電算室で、まず原因を見てきてほしいです。',
    },
