...
export const SPRINT3_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    title: '最後のレトロ：根を張る文化',
    narrative:
      'キャンペーン最後の{{レトロスペクティブ}}。信頼を積み、現場と一緒に隠れたノウハウを形にした自動化は、本番でも例外まで含めて回っている。予測した分を例外処理まで{{完成の定義}}に織り込んで届けきり、持ち越しを最小に締めた。田淵さんが言う。「正直、最初はあんたが仕事を奪いに来たと思ってた」。学びをどう残す？',
    hearingOptions: [
  ...
  },
  {
    ...
    title: '最後のレトロスペクティブ',
    narrative:
      'キャンペーン最後の{{レトロスペクティブ}}。予測した分のうち何を{{完成の定義}}まで終わらせ、何を持ち越したか——3スプリント分を並べると、チームは口々に言う。「{{KPI}}を“誤出荷を減らす”に据えられるかどうかで、結果がここまで変わるとは。機能数を追っていたら、作ったものは全部やり直しだった」。この案件の学びをどう残す？',
    hearingOptions: [
