...
export const SPRINT2_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '口頭で「OK」もらった話、仕様が曖昧なままで…会議室で、ちゃんと決めてきてほしいです。',
    },
  ...
  },
  {
    ...
    advocacy: {
      ...
      dev: '「専門性なんて要る？」って…正直その油断が事故になるんです。倉庫で実務を見てきてほしいです。',
    },
  ...
  },
  {
    ...
    advocacy: {
      po: '「クロスドッキングで在庫ゼロだ」——威勢はいいが、現場は別物だ。倉庫で実態を確かめてくれ。',
      sm: '「在庫ゼロ」と言い切れるのか。倉庫で、その流れの詰まりを見てこい。',
      dev: '「クロスドッキングで在庫ゼロ」、理屈は分かるんですけど…倉庫で実物の動きを見てきてほしいです。',
    },
    narrative:
