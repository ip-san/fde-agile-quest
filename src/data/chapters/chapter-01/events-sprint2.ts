...
export const SPRINT2_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    title: '失効した入館証',
    narrative:
      '朝、入館証がゲートで弾かれた。更新の申請が総務部で止まっていたらしい。今日は中に入れず、現場の作業まで止まりかける。窓口は「期限切れですので再申請を」と取り合わない。',
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    title: '下げられる評価',
    narrative:
      '総務部経由で、橋本さんの人事評価が「改革に非協力的」と低く付けられそうだと知った。実際は、属人化したシステムを一人で支えているからこそ慎重なだけ。赤城部長の差し金らしい。評価会議は近い。',
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    location: 'soumu',
    hints: {
      po: '人員削減の話が総務部で動いてる。現場の実力を踏まえて利害を確かめてきて。',
      sm: 'コスト目標が現場を圧迫しそう。総務部で誰がどう握ってるか見てきて。',
      dev: '人を2割減らすと誤出荷がどうなるか、総務部で前提の数字を確かめて。',
    },
    title: '「人を減らして数字を作れ」',
    narrative:
      '赤城部長が物流コストの数字を握って迫る。「来期、庫内の人を2割減らせ。それで利益が出る」。だが現場はいまでもギリギリで、削れば{{誤出荷率}}が跳ねるのは目に見えている。',
    choices: [
      {
        id: 'a',
