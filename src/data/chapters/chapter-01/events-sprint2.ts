    ...
    choices: [
      {
        ...
        effects: { trust: 1, culture: -1 },
        resultText:
          '結城さんは安堵した（要望に応えて信頼+）。割り込み機能が今の{{スプリントバックログ}}へ差し込まれ、予測は膨らんだ。途中で引き込むこと自体が悪いのではない——容量に余裕があれば、結城さんとゴールを書き換えて正式に差し替えるのは正道だ。問題は、ゴールを危うくする変更を無交渉のまま呑んだこと。誤出荷を減らすという今週の焦点とは別筋の機能を、ただ足した。二兎を追えば、元のゴールも割り込みも、どちらも中途で止まりかねない。',
