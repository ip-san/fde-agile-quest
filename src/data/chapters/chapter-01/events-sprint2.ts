...
export const SPRINT2_EVENTS: GameEvent[] = [
  ...
  // 上にしか乗らない——という学びの芯。視察団来訪（visit）とは別物の“見学”として両立。
  {
    ...
    title: '試作ロボットのお披露目',
    narrative:
      'ジェネリック電機が、自社開発の{{フィジカルAI}}の試作機をカルゴ物流の倉庫に“持ち込んで”、グループ向けにお披露目していた。導入したわけではない——お披露目が終われば持ち帰られる、文字どおりのデモ機だ。倉庫の一角だけ床に真新しい誘導ラインが引かれ、白い搬送ロボットがその線の上だけをするすると往復する。脇に据えたアームが箱をつまんでは番重に並べ、{{バーコード}}を読んで棚番を照合する。前に人が立つと、速度を落として止まる。スーツの一団が「これが物流の未来です」と頷く。だが視線を5メートル横にずらせば、そこは田淵さんの世界だ。手書き台帳と、線を無視して通路を横切るフォークリフト。ロボットが触れているのは、整えられたデモ用の棚だけ——実際の出荷の8割は、いまも田淵さんの勘と紙で回っている。',
    choices: [
      {
        id: 'a',
