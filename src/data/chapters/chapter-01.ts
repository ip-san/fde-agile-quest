    ...
    choices: [
      {
        ...
        effects: { trust: 1, insight: -1 },
        resultText: '機能が増え、情シスは進捗が見えて一旦満足（信頼+）。だがAIが生んだ余白を、また机上の開発に使ってしまった。',
      },
      {
        id: 'b',
    ...
    choices: [
      {
        ...
        effects: { trust: 1, insight: -1 },
        resultText:
          '“きちんとしたものを出してくれる”と情シスは安心（完成度が見えて信頼+）。だが本番に出ないコードは、ただの仮説のまま。学びは得られない。',
        warn: true,
      },
      {
        id: 'b',
    ...
    choices: [
      {
        ...
        effects: { trust: -1, insight: -1 },
        resultText:
          '代案を出さず即「できません」と断り、情シスは突き放された顔（押し返して信頼−）。だが「できません」の前に最小版を、「難しい」の前に分解を試したか？',
        warn: true,
      },
      {
        id: 'b',
    ...
    choices: [
      {
        ...
        effects: { trust: 1, culture: -1 },
        resultText:
          '手が動いたぶんだけ情シスへの見せ場は増えた（信頼+）。だが振り返りは形骸化し、やり方は変わらない。',
      },
      {
        id: 'b',
