...
export const EVENT_PRECEPTS: Record<string, number[]> = {
  ...
  's1-physical-ai-showcase': [1, 19], // 現場に行け答えは資料の外 / 使われない高機能より毎日使われる小機能（試作ロボの実物を見て、土台が先と気づく）
  ...
  's2-daily-jousys-perm': [61, 59],
  's2-daily-shadow-it': [28, 2],
  's2-daily-missed-context': [1, 67],
  ...
  's3-review': [53, 54],
  's3-review-topdown': [89, 65],
  's3-review-trust': [64, 99],
  's3-retro': [98, 99],
  ...
  's3-daily-keiri-closing': [53, 73],
  's3-daily-soumu-expense': [59, 60],
  ...
  // 縦糸 borrowedDebt の取り立て：結城さんに「後で必ず返す」と握った“約束つき”の借入をその期日のうちに果たす。
  // undone-debt（無自覚なDoD妥協＝[97,13]）との決定的な差は「顧客と約束を交わしたか否か」。差別化を心得レイヤーまで一貫させ、
  // 速さは礼儀・品質は責任(97)＋口頭合意を信じるな、形にしろ(78：握った“後で”をバックログの期日へ落として履行＝約束を形にする)。
  's2-daily-debt-collection': [97, 78],
