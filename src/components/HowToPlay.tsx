...
const HOW_TO_PLAY: HowToSection[] = [
  ...
  },
  {
    ...
    lines: [
      'ゴールを決め、{{プロダクトバックログ}}の上位（価値順）から順に{{スプリント予測}}を組む。',
      '上位優先＝飛ばし入れはできない。下位を上げたいなら、並びをPOに提案し価値の論拠で説得する。',
      '1日の{{レビュー}}容量（毎デイリー回復・使い切り）を超えて積むのは自由＝”賭け”。終わらない分は{{キャリーオーバー}}（次へ持ち越し）。',
    ],
  },
  {
    heading: '🧮 カンバン（着手・レビュー）',
    lines: [
      '着手はAIが下書きを生成（生成AIトークンを消費）。AIにどこまで任せ、人がどれぐらい確かめるか——この配分が成果を左右する。',
      '{{仕掛り}}（WIP）は2で詰まり、{{制約理論}}どおり1日のレビュー容量がボトルネックになる。容量は毎デイリー開始時に回復し使い切り（繰り越しなし）。レトロのcapacity改善で1日あたり+1される。',
      '浅い＝AIに任せて速く通す（{{完成の定義}}妥協・負債リスク）。深い＝人が確かめる（{{完成の定義}}達成・品質）。',
    ],
  },
  {
    heading: '✅ レビューとレトロ',
